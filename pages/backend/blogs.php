...
?>
                ...
                <div class="actions-toolbar py-2 mb-4">
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col">
                            <h5 class="mb-1"><?php echo 'GIEQs Blogs';?></h5>
    ...
    function deleteEmailContent(id) {
        ...
        var request = $.ajax({
            url: siteRoot + "assets/scripts/courses/deleteBlogContent.php",
            type: "POST",
    ...
    function refreshModal() {
        ...
        var request = $.ajax({
            ...
            url: siteRoot + "assets/scripts/getBlogModal.php",
            type: "POST",
            contentType: "application/json",
            data: jsonString,
