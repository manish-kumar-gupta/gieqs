...
?>
    ...
    <title>Ghent International Endoscopy Symposium - Backend - Sponsor Editor</title>
                    ...
                    <div class=" col-lg-12">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-md-5 mb-4 mb-md-0">
                                <span class="h2 mb-0 text-white d-block">Partner Manager</span>
...
echo $pdocrud->dbTable("partner")->render();
