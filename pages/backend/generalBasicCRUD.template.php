...
function fillForm (idPassed){
    ...
    function submit<?php echo $databaseName;?>Form (){
        ...
        if (edit == 0){
            ...
            var esdLesionObject = pushDataFromFormAJAX("<?php echo $databaseName;?>-form", "<?php echo $databaseName;?>", "id", null, "0"); //insert new object
            ...
            if (lesionUnderEdit){
                ...
                var esdLesionObject = pushDataFromFormAJAX("<?php echo $databaseName;?>-form", "<?php echo $databaseName;?>", "id", lesionUnderEdit, "1"); //insert new object
    ...
    //delete behaviour
        ...
        if (confirm("Do you wish to delete this <?php echo $databaseName;?>?")) {
            ...
            var esdLesionObject = pushDataFromFormAJAX("<?php echo $databaseName;?>-form", "<?php echo $databaseName;?>", "id", id, "2"); //delete esdLesion
