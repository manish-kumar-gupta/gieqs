...
$databaseName = 'institutional_users';
...
if (isset($_GET['tokenid']) && is_numeric($_GET['tokenid'])) {
...
if (isset($_GET['institutionalid']) && is_numeric($_GET['institutionalid'])) {
    $institutional_id = $_GET['institutionalid'];
    //echo $identifierValue;
...
if (isset($tokenid)) {
    ...
    $validRecord = $token->matchRecord($tokenid);

    if ($validRecord === false) {
        echo "No token with that id exists";
        exit();

    }
}

if (isset($institutional_id)) {

    //$sessionIdentifier = $identifierValue;

    $validRecord = $institutional->matchRecord($institutional_id);

    if ($validRecord === false) {
        echo "No institution with that id exists";
        exit();
...
?>
<div id="tokenid" style="display:none;"><?php echo $tokenid;?>
</div>
<div id="institutionalid" style="display:none;"><?php echo $institutional_id;?>
</div>
...
?>
                ...
                <div class="actions-toolbar py-2 mb-4">
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col">
                            <h5 class="mb-1"><?php echo 'Users for the Specified Institution';?></h5>
                            <p class="text-sm text-muted mb-0 d-none d-md-block">View, Edit, Export.</p>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <label for="name">name</label>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <option value="1">Site Wide Subscription</option>
                                        ...
                                        <label for="videos">Linked Videos</label>
                                        <div class="input-group mb-3">
                                            <select id="videos" type="text" data-toggle="select" class="form-control videos" name="videos" data-disabled="true">
                                            <!--TODO get centres from AJAX-->
                                            <!--or direct from PHP-->
                                            <?php echo $videosAccess->generateVideoRegistrationOptions();?>

                                            
                                            </select>
                                        </div>

                                        <label for="registrations">Linked Programmes</label>
                                        <div class="input-group mb-3">
 ...
 -->
    ...
    function fillForm(idPassed) {
        ...
        var request = $.ajax({
            url: siteRoot + "assets/scripts/getAssetProgrammes.php",
            type: "POST",
...
processResults: function(data) {
        ...
        'type': 'POST',
        'url': siteRoot +
                'assets/scripts/tableInteractors/refreshinstitutional_userstable.php',
        'data': {
           tokenid: $('#tokenid').text(),
           institutionalid: $('#institutionalid').text(),
           // etc..
        },
    },
