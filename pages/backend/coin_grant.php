...
?>
    ...
    <title>Ghent International Endoscopy Symposium - Backend - Coin Grant Manager</title>
                    ...
                    <div class=" col-lg-12">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-md-5 mb-4 mb-md-0">
                                <span class="h2 mb-0 text-white d-block">Coin Grant Manager</span>
...
$pdocrud->fieldTypes("allocated_date", "date");

    
echo $pdocrud->dbTable("coin_grant")->render();
