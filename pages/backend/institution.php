...
?>
    ...
    <title>Ghent International Endoscopy Symposium - Backend - Institution Editor</title>
                    ...
                    <div class=" col-lg-12">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-md-5 mb-4 mb-md-0">
                                <span class="h2 mb-0 text-white d-block">Institution Manager</span>
...
$pdocrud->fieldTypes("logo_src", "IMAGE");//change type to image

$pdocrud->viewColFormatting("logo_src", "image");



$pdocrud->fieldTypes("created", "date");
    
echo $pdocrud->dbTable("institutional")->render();
