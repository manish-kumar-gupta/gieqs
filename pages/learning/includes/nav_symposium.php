...
<nav class="mt-2 navbar navbar-horizontal navbar-expand-lg navbar-dark gieqsGold sticky-top" style="z-index: 1 !important;">
    <div class="container">
        <a class="navbar-brand" href="<?php echo BASE_URL; ?>/pages/learning/index.php"><?php echo 'Symposium';?>
        </a>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon">
                        <span class="nav-link-inner--text <?php echo $symposium_nav_active[0];?> ">News</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon cursor-pointer">
