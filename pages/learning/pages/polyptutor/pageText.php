...
echo "\n";
echo "    <!--Page title-->\n";
echo "    <title>GIEQs Online Endoscopy Trainer - Polypectomy Imaging Videos</title>\n";
echo "\n";
...
echo "\n";
echo "        <?php\n";
echo "        \$requiredTagCategories = ['71', '72', '73', '74', '75', '76', '92', '103', '84'];\n";
echo "\n";
echo "        ?>\n";
echo "\n";
...
echo "            <div class=\"h1 mr-auto\">Endoscopic Imaging Tutor</div>\n";
echo "            <nav aria-label=\"breadcrumb\" class=\"align-self-center\">\n";
echo "                                <ol class=\"breadcrumb breadcrumb-links p-0 m-0\">\n";
echo "                                    <li class=\"breadcrumb-item\"><a href=\"<?php echo BASE_URL . '/pages/learning/index.php'?>\">GIEQs online</a></li>\n";
echo "                                    <li class=\"breadcrumb-item gieqsGold\">Endoscopic Imaging Tutor</a></li>\n";
echo "                                </ol>\n";
echo "                            </nav>\n";
echo "    \n";
echo "        </div>\n";
echo "    <div class=\"d-flex align-items-end container\">\n";
echo "        <p class=\"text-muted pl-4 mt-2\">Endoscopic imaging allows detailed interrogation of colorectal polyps of all sizes.</p>\n";
echo "\n";
echo "    </div>\n";
echo "\n";
echo "\n";
...
echo "\n";
echo "                        \$('#videoCards').html(\"<div class=\\\"d-flex align-items-center\\\"><strong>Loading...</strong><div class=\\\"spinner-border ml-auto\\\" role=\\\"status\\\" aria-hidden=\\\"true\\\"></div></div>\");\n";
...
echo "\n";
echo "					},\n";
echo "					url: siteRoot + \"/pages/learning/scripts/getVideos.php\",\n";
echo "					type: \"POST\",\n";
echo "					contentType: \"application/json\",\n";
