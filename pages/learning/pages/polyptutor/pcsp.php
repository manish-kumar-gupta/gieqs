...
<!--
    ...
    <div class="d-flex align-items-end container">
        <p class="h1 mt-10">Piecemeal Cold Snare Polypectomy</p>

    </div>
    <div class="d-flex align-items-end container">
        <p class="text-muted pl-4 mt-2">Piecemeal Cold Snare Polypectomy (pCSP) allows the resection of larger sessile serrated polyps.</p>
