...
//error_reporting(E_ALL);
    ...
    <!--Page title-->
    <title>GIEQs Online Endoscopy Trainer - Favourite Videos</title>
...
<body>
    ...
    <?php
        ...
        $requiredVideos = $usersSocial->getAllFavourites($userid);

        //$requiredVideos = ['103', '100', '103'];
...
<!--
    ...
    <div class="d-flex align-items-end container">
        <p class="h1 mt-10">Favourite Videos</p>
        

    </div>
    <p class="h4 gieqsGold container ">Pick up where you left off</p>

    <div class="d-flex align-items-end container">
        <p class="text-muted pl-4 mt-2">Below you will find your favourited videos in the order in which you stored them.</p>
