...
//error_reporting(E_ALL);
    ...
    <!--Page title-->
    <title>Medtronic - proudly sponsors GIEQs</title>
...
<body>
    ...
    <?php
        ...
        <body>
            ...
            <?php $livepage = 'Medtronic.  Proud Silver sponsor of GIEQs';?>
...
<?php require (BASE_URI . '/pages/learning/pages/live/liveNav.php');?>
      ...
      <div class="row mb-3">
          <div class="col-lg-12 text-center justify-content-center mb-3">
              ...
              <div class="text-center d-flex justify-content-center">
                  <img alt="Boston Scientific" src="./assets/medtronic.png" style="max-width:100%;max-height:20vh">
              </div>
            ...
            <div class="text-center">
              ...
              <div class="row justify-content-center">
                <div class="col-lg-6">
                  ...
                  <a href="https://vimeo.com/465139814" class="btn btn-lg btn-white btn-icon-only rounded-circle hover-scale-110 mt-4" data-fancybox="">
      ...
      <div class="container">
        <div class="card-group flex-column flex-lg-row">
          <div class="card bg-gradient-primary border-0 px-4 py-5 mt--150">
            <div class="card-body">
              <h5 class="h4 text-white">Supporting Colonic Polyp Detection with the GI Genius™ intelligent endoscopy module. </h5>
          ...
          <div class="card bg-gradient-dark border-0 px-4 py-5 mt--150">
            <div class="card-body">
              <h5 class="h4 text-white">The Barrx™ system is designed to remove the Barrett's epithelium</h5>
              <p class="mt-4 mb-0 text-white">
                            </p>
            </div>
          </div>
          <div class="card bg-gradient-primary border-0 px-4 py-5 mt--150">
            <div class="card-body">
              <h5 class="h4 text-white">Endoflip™ impedance planimetry system</h5>
              <p class="mt-4 mb-0 text-white">
    ...
    <section class="slice slice-lg">
      <div class="container">
        ...
        <div class="alert alert-modern alert-dark">
                                ...
                                <span class="alert-content">GI Genius™</span>
                             </div>
          <h3 class=" mt-4">THE RESULTS Intelligent endoscopy system</h3>
          <div class="fluid-paragraph mt-3">
            <p class="lead lh-180">Colonoscopies with computer aided polyp detection increased adenoma detection rates (ADR) vs. High definition alone</p>
          </div>
        </div>
        <!-- Milestones -->
	...
	-->
                ...
                <!--<div class="h1 text-primary">
                  <span class="counter counting-finished" data-from="0" data-to="97" data-speed="3000" data-refresh-interval="100">97</span>
	...
	-->
                ...
                <!--<div class="h1 text-primary">
                  <span class="counter counting-finished" data-from="0" data-to="365" data-speed="3000" data-refresh-interval="100">365</span>
	...
	-->
                ...
                <!--<div class="h1 text-primary">
                  <span class="counter counting-finished" data-from="0" data-to="200" data-speed="3000" data-refresh-interval="100">200</span>
                  <span class="counter-extra">+</span>
                </div>
	...
	-->
                ...
                <!--<div class="h1 text-primary">
                  <span class="counter counting-finished" data-from="0" data-to="970" data-speed="3000" data-refresh-interval="100">970</span>
                  <span class="counter-extra">+</span>
                </div>
    ...
    <section class="slice slice-lg">
      <div class="container">
        <div class="row row-grid">
          <div class="col-lg-3">
            <h4 class="mt-3">Innovative Solution</h4>
            <p class="lead mt-4">Supporting Colonic Polyp Detection. Introducing artificial intelligence (AI) for colonoscopy with the GI Genius intelligent endoscopy module.</p>
            <a href="https://www.medtronic.com/covidien/en-gb/products.html" class="btn btn-primary btn-icon rounded-pill hover-scale-110 mt-4">
          ...
          <div class="col-lg-6">
            <div class="px-4">
              <img alt="Image placeholder" src="./assets/Medtronic_gi-genius2.jpg" class="img-fluid rounded shadow-lg hover-scale-110">
            </div>
          </div>
          <div class="col-lg-3 d-lg-flex flex-lg-column">
            <div class="mt-lg-auto">
              <p class="lead"> 
			  <ul><li>All technology trained to DETECT colorectal polyps using data set > 13 Mio images</li>
					<li>Automatically identifying & marketing abnormalities consistent with colorectal polyps, including those with flat (non-polypoid) morphology</li>
					<li>Works in real-time</li>
					<li>Scope agnostic- Seamless integration into your existing endoscopy equipment</li>
					<li>Clinical data by Repici showed an increase in ADR & APC</li>
					<li>New DETECTION 2.0 software released with increased sensitivity to 100% and decreased false positives by 47%</li></ul></p>
            </div>
            <div class="mt-lg-auto">
              <p class="lead mb-0"></p>
      ...
      <div class="container no-padding">
        ...
        <div class="card-deck">
          <div class="card hover-shadow-lg">
            <div class="card-body">
              <div class="delimiter-bottom pb-3 mb-4">
                <img alt="Image placeholder" src="./assets/Medtronic_gi-genius2.jpg" class="svg-inject" style="height: 100px; width: auto">
                <h5 class="mt-4">Innovative Solution</h5>
              </div>
          ...
          <div class="card hover-shadow-lg">
            <div class="card-body">
              <div class="delimiter-bottom pb-3 mb-4">
                <img alt="Image placeholder" src="./assets/Medtronic_barrx.jpg" class="svg-inject" style="height: 100px; width: auto">
                <h5 class="mt-4">The Barrx™ system is designed to remove the Barrett's epithelium</h5>
              </div>
          ...
          <div class="card hover-shadow-lg">
            <div class="card-body">
              <div class="delimiter-bottom pb-3 mb-4">
                <img alt="Image placeholder" src="./assets/Medtronic_endoflip.jpeg" class="svg-inject" style="height: 100px; width: auto">
                <h5 class="mt-4">Endoflip™ impedance planimetry system</h5>
              </div>
              ...
              <div class="swiper-container swiper-container-horizontal" data-swiper-items="1" data-swiper-space-between="0" style="cursor: grab;">
                <div class="swiper-wrapper">
                  <div class="swiper-slide swiper-slide-active" style="width: 825px;">
                    <div class="text-center">
                      <p class="h2 lh-160 text-gray font-italic font-weight-300" style="font-family: &#39;Playfair Display&#39;, serif;"></p>
    ...
    <section class="slice slice-lg">
      <div class="container">
        <div class="mb-5 text-center">
          ...
          <div class="fluid-paragraph mt-3">
            <p class="lead lh-180">Come and <a href="https://www.linkedin.com/showcase/medtronic-emea">visit our homepage</a> for more about Medtronics.</p>
          </div>
        </div>
        <div class="row justify-content-center">
