            ...
            <div class="container-fluid d-flex flex-wrap align-items-lg-stretch p-2 p-lg-5" style="max-height:60vh;">
                <div class="col-lg-5 ml-4" style="cursor:none;">
                    <h2 class="mb-5">LIVE area</h2>
                                        <div class="card mb-0 p-2 tagCard mx-6" style="height:10vh; width:100%; overflow:hidden; cursor:none; margin-top: 10rem !important;">
                    ...
                    <div class="input-group ">
                        <select id="tags" type="text" data-toggle="select" class="form-control" name="tags">
                            <?php
                                        ...
                                        echo $general->generateMaterialsStructure();
...
?>
                    ...
                    <div class="card mb-0 p-2 mx-6 tagCard" style="height:10vh; width:100%; overflow:hidden; margin-top: 3.25rem !important;">
                       <!--  <div class="card-header tagCardHeader mb-0">
...
?>
            ...
            $(document).ready(function() {
                ...
                $(document).on('change', '#tags', function () {
                    ...
                    }($('#tagsDisplayMirror').prepend('<span class="animated rubberBand badge even-larger-badge bg-gieqsBlue text-dark mx-2 my-2" data="tag' + x + '" id="tag' + x + '" style="max-width:100%; text-align:justify; white-space:normal;">' + tagName + '</span>')));



                    $('#tagsDisplayMirror').find('span').not('#tag' + x).removeClass('bg-gieqsBlue').removeClass('text-dark').removeClass('even-larger-badge').addClass('bg-secondary-dark').addClass('text-white');
                    $('#tagsDisplayMirror').find('span').not('#tag' + x).each(function(){

                        $(this).removeClass('bg-gieqsBlue').removeClass('text-dark').removeClass('even-larger-badge').addClass('bg-secondary-dark').addClass('text-white');
                    ...
                    }($('#tagsDisplay').prepend('<span class="animated rubberBand badge even-larger-badge bg-gieqsBlue text-dark mx-2 my-2" data="tag' + y + '" id="tag' + y + '" style="max-width:100%; text-align:justify; white-space:normal;">' + tagName + '</span>')));



                    $('#tagsDisplay').find('span').not('#tag' + y).removeClass('bg-gieqsBlue').removeClass('text-dark').removeClass('even-larger-badge').addClass('bg-secondary-dark').addClass('text-white');
