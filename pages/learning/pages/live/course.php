...
<body>
    ...
    <body>
      ...
      //program get the livestream from thee database

      ?>

                <?php $livepage = $page_title;
            ...
            //get programme from asset

            $programmes = $assetManager->returnProgrammesAsset($assetid);

            $programme->Load_from_key($programmes[0]); 
    //print_r($programmes);

    ?>

                                <iframe src="<?php echo $programme->geturl_vimeo(); ?>" frameborder="0"
...
?>
                ...
                <script src="<?php echo BASE_URL;?>/assets/libs/@fancyapps/fancybox/dist/jquery.fancybox.min.js">
                </script>
                <script src="assets/libs/typed.js/lib/typed.min.js"></script>
                <script src="assets/libs/isotope-layout/dist/isotope.pkgd.min.js"></script>
                <script src="assets/libs/jquery-countdown/dist/jquery.countdown.min.js"></script>
                <!-- Google maps -->
                <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCBuyKngB9VC3zgY_uEB-DKL9BKYMekbeY">
                </script>
                <!-- Purpose JS -->
