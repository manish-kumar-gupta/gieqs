...
-->
    ...
    <div class="main-content bg-gradient-dark">
        ...
        <div class="d-flex align-items-end container">
            <p class="text-muted pl-4 mt-2">All the information you need to progress in your Polypectomy Practice with GPAT</p>
...
echo '<li class="toc-entry toc-h4" style="font-size:1.0rem;"><a class="text-muted" href="#difficulty">Procedures Stratified by Difficulty</a></li>';
            ...
            ?>
                            ...
                            <span id="summary"
                              ...
                              <p style="font-size:1.3rem;">We’re constantly looking for ways to improve the Dropbox experience and to ensure that our policies explain how our services work. So we’re letting you know about a few updates to our Terms of Service and Privacy Policy. Here’s a summary of the key changes:</p>      
