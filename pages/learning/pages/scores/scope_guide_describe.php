 ...
 -->
		...
		<form action="adminGenerateUserEmail.php" method="post">
            <fieldset>
				...
				$formv1->generateSelectCustom ('1. Location Scope Tip:', 'location_tip', 'factor', array('1'=>'Rectum <5cm from anal verge', '2'=>'Rectum >5cm from anal verge', '3'=>'Sigmoid','4'=>'descending colon','5'=>'splenic flexure','6'=>'Distal transverse colon', '7'=>'Mid transverse colon','8'=>'proximal transverse colon','9'=>'Hepatic flexure','10'=>'Ascending colon','11'=>'caecum','12'=>'caecum appendiceal orifice', '13'=>'caecum ileocaecal valve'), 'Location of the endoscope tip');
				echo '<br/>';

                
				$formv1->generateSelectCustom ('2. Location Loop:', 'location_loop', 'factor', array('1'=>'Rectum <5cm from anal verge', '2'=>'Rectum >5cm from anal verge', '3'=>'Sigmoid','4'=>'descending colon','5'=>'splenic flexure','6'=>'Distal transverse colon', '7'=>'Mid transverse colon','8'=>'proximal transverse colon','9'=>'Hepatic flexure','10'=>'Ascending colon','11'=>'caecum','12'=>'caecum appendiceal orifice', '13'=>'caecum ileocaecal valve'), 'Location of the loop in the patients abdomen');
				echo '<br/>';


                $formv1->generateSelectCustom ('3. Loop name:', 'loop_name', 'factor', array('1'=>'N spiral', '2'=>'Alpha', '3'=>'Reverse Alpha','4'=>'Splenic','5'=>'Gamma','6'=>'Mid Transverse Dip', '7'=>'Medial Lying Caecum','8'=>'High Riding Splenic','9'=>'Bowing Sigmoid',), 'Description of the type of loop');
				echo '<br/>';
			
                
                $formv1->generateSelectCustom ('4. Loop Lateral Deflection (predominant, relative to patient):', 'loop_lateral', 'factor', array('1'=>'right', '2'=>'neutral', '3'=>'left',), 'Loop Lateral Deflection (predominant, relative to patient');
				echo '<br/>';
                
                $formv1->generateSelectCustom ('5. Loop AP Deflection (predominant, relative to patient):', 'loop_ap', 'factor', array('1'=>'anterior', '2'=>'neutral', '3'=>'posterior',), 'Loop AP Deflection (predominant, relative to patient');
				echo '<br/>';   
                
                $formv1->generateSelectCustom ('6. Position AP of distal shaft (nearest endoscopist hand, relative to loop):', 'distal_part_relative_loop', 'factor', array('1'=>'anterior', '2'=>'posterior',), 'Position AP of distal shaft (nearest endoscopist hand, relative to loop)');
				echo '<br/>';
