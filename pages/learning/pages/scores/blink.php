...
<!--
    ...
    <div class="d-flex align-items-end container">
        <p class="h1 mt-10">Blink Deconstruction Generator</p>
 ...
 -->
		...
		<form action="adminGenerateUserEmail.php" method="post">
            <fieldset>
				...
				$formv1->generateSelectCustom ('1. Fold deformation:', 'folds', 'factor', array('0' => '0 - Not present', '1' => '1 - Present'), 'the contour of a colonic haustral fold is interrupted within the polyp // folds converge on this area?');
				echo '<br/>';

                $formv1->generateSelectCustom ('2. Extra redness:', 'redness', 'factor', array('0' => '0 - Not present', '1' => '1 - Present'), 'extra redness - one area of the polyp is more red than the rest of the polyp');
				echo '<br/>';
			
                $formv1->generateSelectCustom ('3. Depression:', 'depression', 'factor', array('0' => '0 - Not present', '1' => '1 - Present'), 'an area within the polyp is sunken/concave with respect to the rest of the polyp');
				echo '<br/>';

                $formv1->generateSelectCustom ('4. Chicken skin:', 'chicken_skin', 'factor', array('0' => '0 - Not present', '1' => '1 - Present'), 'speckled mucosa surrounding the polyp resembling chicken skin');
				echo '<br/>';

                $formv1->generateSelectCustom ('5. Ulceration:', 'ulceration', 'factor', array('0' => '0 - Not present', '1' => '1 - Present'), 'presence of ulceration within the polyp');
				echo '<br/>';


                $formv1->generateSelectCustom ('6. Spontaneous Bleeding:', 'bleeding', 'factor', array('0' => '0 - Not present', '1' => '1 - Present'), 'presence of bleeding on the surface of the polyp not explained by biopsy/scope contact');
				echo '<br/>';
...
//EDITED BLINK
        ...
        function generateScore(){
                ...
                var folds = $('#folds').val();
				var redness = $('#redness').val();
				var depression = $('#depression').val();
				var chicken_skin = $('#chicken_skin').val();
				var ulceration = $('#ulceration').val();
