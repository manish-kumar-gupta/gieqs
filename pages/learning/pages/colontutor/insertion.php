...
<body>
    ...
    <?php
        ...
        <?php
        $requiredTagCategories = ['47', '48', '50', '55'];
...
<!--
    ...
    <div class="d-flex flex-wrap container pt-10 mt-5">
        <div class="h1 mr-auto">Insertion Technique</div>
        <nav aria-label="breadcrumb" class="align-self-center">
                            <ol class="breadcrumb breadcrumb-links p-0 m-0">
                                ...
                                <li class="breadcrumb-item gieqsGold" aria-current="page">Insertion Technique</li>
                            </ol>
                        </nav>
