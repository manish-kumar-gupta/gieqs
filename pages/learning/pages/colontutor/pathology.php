...
<body>
    ...
    <?php
        ...
        <?php
        $requiredTagCategories = ['47', '48', '53', '56'];
...
<!--
    ...
    <div class="d-flex flex-wrap container pt-10">
        <div class="h1 mr-auto">Management of Pathology</div>
        <nav aria-label="breadcrumb" class="align-self-center">
                            <ol class="breadcrumb breadcrumb-links p-0 m-0">
                                ...
                                <li class="breadcrumb-item gieqsGold" aria-current="page">Management of Pathology</li>
                            </ol>
                        </nav>
