...
//error_reporting(E_ALL);
    ...
    <!--Page title-->
    <title>GIEQs Online Endoscopy Trainer - GIEQs Digital Catch Up</title>
...
<!--
    ...
    <div class="d-flex flex-wrap container pt-10 mt-5">
        <div class="h1 mr-auto">GIEQs Digital Edition I</div>
        <nav aria-label="breadcrumb" class="align-self-center">
                            <ol class="breadcrumb breadcrumb-links p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo BASE_URL . '/pages/learning/pages/ERCP/ercp.php'?>">GIEQs Digital Catch Up</a></li>
                                <li class="breadcrumb-item gieqsGold" aria-current="page">All Videos</li>
                            </ol>
                        </nav>
