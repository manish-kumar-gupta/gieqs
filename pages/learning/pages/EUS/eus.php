...
//error_reporting(E_ALL);
    ...
    <!--Page title-->
    <title>GIEQs Online Endoscopy Trainer - EUS, all videos</title>
...
<body>
    ...
    <?php
        ...
        <?php
        $requiredTagCategories = ['131', '132', '133', '134'];
...
<!--
    ...
    <div class="d-flex flex-wrap container pt-10 mt-5">
        <div class="h1 mr-auto">Endoscopic Ultrasound (EUS)</div>
        <nav aria-label="breadcrumb" class="align-self-center">
                            <ol class="breadcrumb breadcrumb-links p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo BASE_URL . '/pages/learning/pages/EUS/eus.php'?>">EUS</a></li>
                                <li class="breadcrumb-item gieqsGold" aria-current="page">EUS</li>
                            </ol>
                        </nav>
