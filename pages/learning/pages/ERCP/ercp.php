...
//error_reporting(E_ALL);
    ...
    <!--Page title-->
    <title>GIEQs Online Endoscopy Trainer - ERCP, all videos</title>
...
<body>
    ...
    <?php
        ...
        <?php
        $requiredTagCategories = ['117', '119', '121', '122', '123', '125', '126', '127', '128'];
...
<!--
    ...
    <div class="d-flex flex-wrap container pt-10 mt-5">
        <div class="h1 mr-auto">Endoscopic Retrograde Pancreatography (ERCP)</div>
        <nav aria-label="breadcrumb" class="align-self-center">
                            <ol class="breadcrumb breadcrumb-links p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo BASE_URL . '/pages/learning/pages/ERCP/ercp.php'?>">ERCP</a></li>
                                <li class="breadcrumb-item gieqsGold" aria-current="page">ERCP</li>
                            </ol>
                        </nav>
