                        ...
                        <div class=" col-lg-12">
                            ...
                            <div class="row align-items-center mb-4">
                                <div class="col-auto mb-4 mb-md-0">
                                    ...
                                    <span class="text-white">Higher Status = Greater Benefits.</span>
                                </div>
                                <!-- video -->
                        ...
                        <div class="row row-grid align-items-center justify-content-center">
                            <div class="col-lg-6">
                                <div class="py-lg-5 text-center"><div class="icon text-white icon-xl">
                                    ...
                                    <h2 class="display-3 text-white mb-3">GIEQs Status</h2>
                                    <p class="display-4 text-white">Bronze < Silver < Gold < Platinum.</p>
                                    <a href="#options-text"
                                        class="btn bg-gieqsGold btn-icon rounded-pill hover-translate-y-n3 mt-5 mb-5">
                                        <span class="btn-inner--icon">
                                            <i class="fas fa-arrow-down text-dark"></i>
                                        </span>
                                        <span class="btn-inner--text text-dark">How it works</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row row-grid align-items-center justify-content-around">
                        ...
                        <div class="col-lg-5 order-lg-1">
                            <div class="pr-md-4">
                                <h5 class="h3">GIEQs Status.</h5>
                                <p class="text-muted lead my-4">GIEQs Status demonstrates <span class="gieqsGold">how far you have progressed</span> on GIEQs Online.  This is how it works... 

                                <ul>

                                    <li class="my-1"><span class="gieqsGold">Every learning experience you undertake
                                        </span> counts towards status.  The more you watch, the further you move towards the next status tier.</li>

                                    <li class="mt-2 my-1">



                                        <p><span class="gieqsGold">There are 4 tiers</span> of GIEQs Status.  Bronze, Silver, Gold and Platinum. </p>
                                    </li>
                                    <li class="mt-2 my-1">



                                        <p><span class="gieqsGold">Bronze is the base status.</span>  You automatically achieve Silver, Gold and Platinum status on completion of 25, 50 and 75% of GIEQs Online content. </p>
                                    </li>
                                ...
                                <a href="#options-table"
                                    ...
                                    <span class="btn-inner--text text-dark">What are the benefits of Status?</span>
                                </a>
                        ...
                        <div class="col-lg-6 order-lg-1">
                            <div class="position-relative" style="z-index: 10;">
                                <img alt="Image placeholder"
                                    src="<?php echo BASE_URL;?>/assets/img/icons/gieqs_gold_medal.svg"
...
<div class="col-lg-5 order-lg-1">
    <div class="pr-md-4">
        <h5 class="h3">Status benefits.</h5>
...
<p><span class="gieqsGold">Once you achieve status you do not lose it.</span></p>
</li>
<li class="mt-2 my-1">



<p><span class="gieqsGold">Status comes with benefits.</span> Gain GIEQs coin rewards, early access to premium materials and courses when your status increases. </p>
</li>
        ...
        <a href="<?php echo BASE_URL;?>/pages/learning/index.php"
            ...
            <span class="btn-inner--text text-dark">Status Dashboard</span>
        </a>
...
<div class="col-lg-6 order-lg-1">
    <div class="position-relative" style="z-index: 10;">
        <img alt="Image placeholder"
            src="<?php echo BASE_URL;?>/assets/img/icons/gieqs_platinum_medal.svg"
