...
$q = "Select * from `usersViewsVideo` LIMIT " . $x . ", " . $y;
...
$q = "Select * from `usersViewsVideo` WHERE `id` = $key";
		$result = $this->connection->RunQuery($q);
							$rowReturn = array();
						$x = 0;
						$nRows = $result->rowCount();
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('usersViewsVideo');
	}
...
$q = "INSERT INTO `usersViewsVideo` ($keys) VALUES ($keys2)";
...
$q = "UPDATE `usersViewsVideo` SET $implodeArray WHERE `id` = '$this->id'";
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `usersViewsVideo` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from usersViewsVideo order by $column $order");
     ...
     */
	public function endusersViewsVideo(){
