...
?>
        ...
        <div class="d-flex align-items-end">
            <div class="container pt-4 pt-lg-4" id="mainContainer">
                ...
                <div class="row" id="videoTitleTour" style="margin-right:15px; margin-left:15px;">
                    <spa class="h3 mb-0  d-block w-lg-75 w-xl-75">
                        ...
                        <div class="collapse card mb-0 p-2 flex-row" id="selectDropdown">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <button type="button" class="close text-right " data-toggle="collapse"
    ...
    padding-bottom: 0.5em;
    padding-top: 0.5em;">
                            <span id="chapterHeading" class="h6 mb-0  d-block">Video Credits</span>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="registerInterestLabel" style="color: #BD9635;">Thank-you for
                        your interest in GIEQs</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span class="" aria-hidden="false">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitPreRegister" type="button" class="btn-small text-black"
                        style="background-color: #BD9635;">Submit</button>
                </div>
            </div>
        </div>
    </div>
