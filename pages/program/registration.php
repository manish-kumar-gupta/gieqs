          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card py-5 px-4 box-shadow-3 mt-0">
                <div class="card-body">
                  <h6 class="h2">
                    <strong>Registration</strong> is now FREE.
                  </h6>
                  <p class="lead lh-180">Thanks to the extremely generous support of our partners registration for GIEQs is now <span class='gieqsGold'>FREE</span> since the event will be fully digital!</p>
                  <p class="lead lh-180">Once you register you will gain access to our unique learning site <span class='gieqsGold'>GIEQs learning</span>.
                      ...
                      <p class="lead lh-180">You will also receive complimentary access to GIEQs learning basic until one week after the event, containing all the content from GIEQs and a selection of our curated learning material.</p>
