...
class Xcrud_config
{
	...
	//load videojs
	public static $load_videojs = true;
    ...
    public static $upload_folder_def = '../../../img/uploads'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    public static $mail_host = 'mail.abc.net'; 
    public static $mail_port = 587; 
    public static $smtp_auth = true; 
    public static $username = 'sales@abc.net'; 
