<?php
            ...
            $sendProgrammeid = $data['programmeid'];
            ...
            if ($debug){
                ...
                echo $sendProgrammeid . 'is sendProgrammeid';
...
//EDIT variable programmes to get MAX 2
                        ...
                        $times = array(1=>'08:30:00', 2=>'10:30:00', 3=>'10:40:00', 4=>'12:30:00', 5=>'13:00:00', 6=>'15:30:00', 7=>'15:40:00', );
                        if ($debug){
                        ...
                        foreach ($times as $timeKey=>$timeValue){
                            ...
                            if ($timeValue == '12:30:00'){
                                ...
                                <div class="row text-center align-middle border-left border-right border-bottom">
                                    ...
                                    <div class="col-12 p-2 pb-3 pt-3">
                                        <span class="h5" style="color: rgb(238, 194, 120);">Lunch Break | 30 min</span>
                                    </div>
