...
Class blog_v2 {
     ...
     *
     */
	public function New_blog_v2($video_id,$user_id,$title,$description,$created){
	...
	public function Load_from_key($key_row){
		$result = $this->connection->RunQuery("Select * from blog_v2 where id = \"$key_row\" ");
...
$q = "Select * from `blog_v2` LIMIT " . $x . ", " . $y;
...
$q = "Select * from `blog_v2` WHERE `id` = $key";
		$result = $this->connection->RunQuery($q);
							$rowReturn = array();
						$x = 0;
						$nRows = $result->rowCount();
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('blog_v2');
	}
...
$q = "INSERT INTO `blog_v2` ($keys) VALUES ($keys2)";
...
$q = "UPDATE `blog_v2` SET $implodeArray WHERE `id` = '$this->id'";
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `blog_v2` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from blog_v2 order by $column $order");
