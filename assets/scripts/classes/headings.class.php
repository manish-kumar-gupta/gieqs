...
Class headings {
	...
	public function Load_from_key($key_row){
		$result = $this->connection->RunQuery("Select * from headings where id = \"$key_row\" ");
...
$q = "Select * from `headings` LIMIT " . $x . ", " . $y;
...
$q = "Select * from `headings` WHERE `id` = $key";
		$result = $this->connection->RunQuery($q);
							$rowReturn = array();
						$x = 0;
						$nRows = $result->rowCount();
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('headings');
	}
...
$q = "INSERT INTO `headings` ($keys) VALUES ($keys2)";
...
$q = "UPDATE `headings` SET $implodeArray WHERE `id` = '$this->id'";
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `headings` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from headings order by $column $order");
	...
	/**
	 * @return navigation_id - int(11)
	 */
	public function getnavigation_id(){
	 ...
	 * @param Type: int(11)
	 */
	public function setnavigation_id($navigation_id){
		$this->navigation_id = $navigation_id;
	}
