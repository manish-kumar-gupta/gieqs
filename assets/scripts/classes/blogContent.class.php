...
Class blogContent {
     ...
     *
     */
	public function New_blogContent($blog_id,$text,$img,$video,$display_order){
	...
	public function Load_from_key($key_row){
		$result = $this->connection->RunQuery("Select * from blogContent where id = \"$key_row\" ");
...
$q = "Select * from `blogContent` LIMIT " . $x . ", " . $y;
...
$q = "Select * from `blogContent` WHERE `id` = $key";
		$result = $this->connection->RunQuery($q);
							$rowReturn = array();
						$x = 0;
						$nRows = $result->rowCount();
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('blogContent');
	}
...
$q = "INSERT INTO `blogContent` ($keys) VALUES ($keys2)";
...
$q = "UPDATE `blogContent` SET $implodeArray WHERE `id` = '$this->id'";
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `blogContent` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from blogContent order by $column $order");
     ...
     */
	public function endblogContent(){
