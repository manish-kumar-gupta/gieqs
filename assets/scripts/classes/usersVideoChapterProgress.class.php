...
Class usersVideoChapterProgress {
     ...
     *
     */
	public function New_usersVideoChapterProgress($user_id,$chapter_id,$progress){
	...
	public function Load_from_key($key_row){
		$result = $this->connection->RunQuery("Select * from usersVideoChapterProgress where id = \"$key_row\" ");
...
$q = "Select * from `usersVideoChapterProgress` LIMIT " . $x . ", " . $y;
...
$q = "Select * from `usersVideoChapterProgress` WHERE `id` = $key";
		$result = $this->connection->RunQuery($q);
							$rowReturn = array();
						$x = 0;
						$nRows = $result->rowCount();
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('usersVideoChapterProgress');
	}
...
$q = "INSERT INTO `usersVideoChapterProgress` ($keys) VALUES ($keys2)";
...
$q = "UPDATE `usersVideoChapterProgress` SET $implodeArray WHERE `id` = '$this->id'";
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `usersVideoChapterProgress` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from usersVideoChapterProgress order by $column $order");
     ...
     */
	public function endusersVideoChapterProgress(){
