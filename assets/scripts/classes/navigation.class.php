...
Class navigation {
	...
	public function Load_from_key($key_row){
		$result = $this->connection->RunQuery("Select * from navigation where id = \"$key_row\" ");
...
$q = "Select * from `navigation` LIMIT " . $x . ", " . $y;
		$result = $this->connection->RunQuery($q);
			...
			$rowReturn[$x]["menu_id"] = $row["menu_id"];
...
$q = "Select * from `navigation` WHERE `id` = $key";
		$result = $this->connection->RunQuery($q);
							$rowReturn = array();
						$x = 0;
						$nRows = $result->rowCount();
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('navigation');
	}
...
$q = "INSERT INTO `navigation` ($keys) VALUES ($keys2)";
...
$q = "UPDATE `navigation` SET $implodeArray WHERE `id` = '$this->id'";
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `navigation` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from navigation order by $column $order");
