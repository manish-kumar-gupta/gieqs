                        ...
                        foreach ($times as $timeKey=>$timeValue){
                            ...
                            if ($debug){
                                ...
                                if ($session1data){
                                    ...
                                    echo '<div class="col-5 p-1 pb-3 pt-3 border-right" style="cursor:pointer !important;" data-toggle="row" data-target="#row-' . $programmeDate->format('l') . '-' . $session1data[0]['programmeid'] . '-' . $sessionTimeFrom->format('Hi') . '">
                                ...
                                <div class="row-lg row-dialog-centered">
                                    ...
                                    <div class="row-content bg-dark border" style="border-color:rgb(238, 194, 120) !important;">
                                        <div class="row-header">
                                            ...
                                            <div class="row-title d-flex align-items-left" id="row-title-change-username">
                                                <div>
                                            ...
                                            <button type="button" class="close" data-dismiss="row" aria-label="Close">
                                                <span="text-white" aria-hidden="true">&times;</span>
                                            </button>

                                        </div>
                                        <div class="row-subheader px-3 mt-2 mb-2 border-bottom">
                                            <div class="row">
                                        ...
                                        <div class="row-footer">
                                            <button type="button" class="btn btn-sm btn-secondary" data-dismiss="row">Back to programme &nbsp; &nbsp;<i
                            ...
                            echo '<div class="col-5 p-1 pb-3 pt-3 border-right" style="cursor:pointer !important;" data-toggle="row" data-target="#row-' . $programmeDate->format('l') . '-' . $session2data[0]['programmeid'] . '-' . $sessionTimeFrom->format('Hi') . '">
                                   ...
                                   echo '
                            <div class="row fade" id="row-' . $programmeDate->format('l') . '-' . $session2data[0]['programmeid'] . '-' . $sessionTimeFrom->format('Hi') . '" tabindex="-1" role="dialog" aria-labelledby="row-change-username" aria-hidden="true">
