...
Class coin_spend {
	...
	public function Load_from_key($key_row){
		$result = $this->connection->RunQuery("Select * from coin_spend where id = \"$key_row\" ");
...
$q = "Select * from `coin_spend` LIMIT " . $x . ", " . $y;
...
$q = "Select * from `coin_spend` WHERE `id` = $key";
		$result = $this->connection->RunQuery($q);
							$rowReturn = array();
						$x = 0;
						$nRows = $result->rowCount();
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('coin_spend');
	}
...
$q = "INSERT INTO `coin_spend` ($keys) VALUES ($keys2)";
...
$q = "UPDATE `coin_spend` SET $implodeArray WHERE `id` = '$this->id'";
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `coin_spend` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from coin_spend order by $column $order");
	...
	/**
	 * @return spend_date - timestamp
	 */
	public function getspend_date(){
	 ...
	 */
	public function setspend_date($spend_date){
		$this->spend_date = $spend_date;
	}
