...
Class sessionOrder {
	...
	private $sessionOrder; //varchar(11)
	private $connection;
     ...
     *
     */
	public function New_sessionOrder($sessionid,$sessionItemid,$sessionOrder){
	...
	public function Load_from_key($key_row){
		$result = $this->connection->RunQuery("Select * from sessionOrder where id = \"$key_row\" ");
		while($row = $result->fetch(PDO::FETCH_ASSOC)){
			$this->id = $row["id"];
			$this->sessionid = $row["sessionid"];
			$this->sessionItemid = $row["sessionItemid"];
			$this->sessionOrder = $row["sessionOrder"];
		}
	}
    /**
...
$q = "Select * from `sessionOrder` LIMIT " . $x . ", " . $y;
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('sessionOrder');
	}
...
echo $q;
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `sessionOrder` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from sessionOrder order by $column $order");
	...
	/**
	 * @return sessionOrder - varchar(11)
	 */
	 ...
	 */
	public function setsessionOrder($sessionOrder){
		$this->sessionOrder = $sessionOrder;
	}
     ...
     */
	public function endsessionOrder(){
