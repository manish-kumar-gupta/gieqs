...
Class sessionItemFaculty {
	...
	public function Load_from_key($key_row){
		$result = $this->connection->RunQuery("Select * from sessionItemFaculty where id = \"$key_row\" ");
...
$q = "Select * from `sessionItemFaculty` LIMIT " . $x . ", " . $y;
	...
	public function numberOfRows(){
		return $this->connection->TotalOfRows('sessionItemFaculty');
	}
...
$q = "INSERT INTO `sessionItemFaculty` ($keys) VALUES ($keys2)";
...
$q = "UPDATE `sessionItemFaculty` SET $implodeArray WHERE `id` = '$this->id'";
 ...
 return $stmt->rowCount(); 
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM `sessionItemFaculty` WHERE `id` = $key_row");
	...
	public function GetKeysOrderBy($column, $order){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT id from sessionItemFaculty order by $column $order");
     ...
     */
	public function endsessionItemFaculty(){
