 ...
 */
    ...
    <?php
                            ...
                            echo ' <div class="col-3 p-1 pb-3 pt-3 border-right ' . $highlight . '">
                            ...
                            if ($debug){
                                ...
                                if ($session1data){
                                    ...
                                    echo '<div class="col-9 p-1 pb-3 pt-3 border-right ' . $highlight . '" style="cursor:pointer !important;" data-toggle="modal" data-target="#modal-' . $programmeDate->format('l') . '-' . $session1data[0]['programmeid'] . '-' . $sessionTimeFrom->format('Hi') . '">
