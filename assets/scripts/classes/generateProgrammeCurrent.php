    ...
    <?php
                            ...
                            if ($debug){
                                ...
                                if ($session1data){
                                    ...
                                    echo '<div class="col-' . $widthData . ' p-1 pb-3 pt-3 border-right ' . $highlight . '" style="cursor:pointer !important;" data-toggle="modal" data-target="#modal-' . $programmeDate->format('l') . '-' . $session1data[0]['programmeid'] . '-' . $sessionTimeFrom->format('Hi') . '">
...
<?php
                                ...
                                if ($session2data){
                                    ...
                                    echo '<div class="col-' . $widthData . ' p-1 pb-3 pt-3 border-right ' . $highlight . '" style="cursor:pointer !important;" data-toggle="modal" data-target="#modal-' . $programmeDate->format('l') . '-' . $session2data[0]['programmeid'] . '-' . $sessionTimeFrom->format('Hi') . '">
