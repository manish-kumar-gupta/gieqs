...
$openaccess =1;
            ...
            if ($update == 0){
                ...
                $targetStatement = '$esdLesion->Load_from_key("' . $sessionItemid . '");';
                    //echo $targetStatement;
                ...
                $updatedSessionItem = $esdLesion->prepareStatementPDOUpdate();
                ...
                $returnArray['updatedSessionItem'] = $updatedSessionItem;
