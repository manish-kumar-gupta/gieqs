<?php
            ...
            <div class="modal fade" id="modal-row-2" role="dialog" aria-labelledby="modal-change-username" aria-hidden="true">
...
<body style="height:100%;margin:0;padding:0;width:100%;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
    ...
    <div class="preheader" style="font-size: 1px; display: none !important;"><?php echo $emails->getpreheader();?></div>
    <center>
...
$emailContents = $emailContent->getEmailContents($emailid);
...
<?php  }?>
                                                                            ...
                                                                            <h3
                                                                                ...
                                                                                Course Joining Instructions</h3>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="mcnImageGroupContent"
                                                                                            ...
                                                                                            <center>
                                                                                                <a href="https://www.gieqs.com/pages/authentication/login.php?destination=gieqsonline"
                                                                                                    target="_blank"><img
                                                                                                        alt=""
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                Thanks for your GIEQs Online Course
                                                                                Subscription to
                                                                                <?php echo $asset_name;?> scheduled for
                                                                                <?php echo $programme_date;?> at
                                                                                <?php echo $programme_start_time;?>
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                Please carefully read the joining
                                                                                instructions below and keep this email
                                                                                as a reference for the day of the
                                                                                course.</p>
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                (online). We have tried hard to make
                                                                                this experience as close
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                interacting on the Zoom stream.</p>
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                After a short delay (+/- 2 days) all
                                                                                materials will be available to watch on
                                                                                demand until your subscription expires.
                                                                                To watch later go to GIEQs Online and
                                                                                choose from the Subscriptions menu or
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                first check your internet connection and
                                                                                / or wifi connection. </p>
                                                                            <p>If you have locked
                                                                                out your account (perhaps logged in on
                                                                                multiple
                                                                                devices or at multiple locations
                                                                                simultaneously) please contact us. To
                                                                                prevent this happening again logout from
                                                                                one device before you login with
                                                                                another. Your account and subscription
                                                                                allows login
                                                                                from as many devices as you wish but not
                                                                                simultaneously.</p>

                                                                            <p
                                                                                style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">

                                                                                For any other technical issues please <a
                                                                                    href="mailto:admin@gieqs.com">contact
                                                                                    us</a>. </p>
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                We greatly appreciate any feedback you
                                                                                may have, positive or negative. </p>
                                                                            <p>We will a link with you after the course.
                                                                                Please take the time to let us know what
                                                                                went well and what could be done better
                                                                                next time.</p>
                                                                            <p>Each completed feedback gives the chance
                                                                                to receieve a FREE subscription to a
                                                                                future GIEQs virtual / hybrid course in
                                                                                the future.</p>
                                                                            ...
                                                                            <p
                                                                                style="margin:10px 0;padding-top:20px;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">
                                                                                We would like to thank you again for
                                                                                your support of
                                                                                GIEQs Online. Your specific subscription
                                                                                details are included again here for
                                                                                reference.</p>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent"
                                                                            ...
                                                                            <p
                                                                                style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;font-weight:bold">
                                                                                Subscription details (you can manage
                                                                                anytime from <a
                                                                                    href="https://www.gieqs.com/pages/authentication/login.php?destination=subscriptions">my
                                                                                    account</a>)</p>
                                                                            <p
                                                                                style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">
                                                                                Invoice ID :
                                                                                <?php echo $subscription_id;?></p>

                                                                            <p
                                                                                style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">
                                                                                Subscription : <?php echo $asset_name;?>
                                                                            </p>
                                                                            <p
                                                                                style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">
                                                                                Type : <?php echo $asset_type;?></p>
                                                                            <p
                                                                                style="margin:10px 0;padding:0;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#757575;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left;">
                                                                                Duration :
