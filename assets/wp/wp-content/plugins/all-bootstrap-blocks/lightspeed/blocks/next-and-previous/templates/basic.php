...
if ( empty( $items['prev']['media'] ) && get_option( 'areoi-lightspeed-company-include-lightspeed', false ) ) {
	$items['prev']['media'] = lightspeed_get_placeholder_images( 1 )['url'];
}
if ( empty( $items['next']['media'] ) && get_option( 'areoi-lightspeed-company-include-lightspeed', false ) ) {
