<div class="areoi-body">
   ...
   <div class="areoi-card active areoi-card-branded">
      ...
      <div class="areoi-card-body" style="width: 60%">
         ...
         <h2>Making a better web, at Lightspeed.</h2>
         <p>We’re currently working on a revolutionary new tool that will give you the power to design and build entire websites in minutes. Sign up to our newsletter and be the first to know when our beta launches.</p>

         <a href="https://areoi.io" target="_blank" class="areoi-button">Visit areoi.io</a>
      ...
      <div class="areoi-card-body areoi-card-body-white" style="width: 40%">
   ...
   <div class="areoi-card active areoi-card-branded" style="background: #7952b3;">
      ...
      <div class="areoi-card-body areoi-card-body-white" style="width: 40%; height: 100%">
   ...
   <div class="areoi-card active areoi-card-branded" style="background: #000;">
      ...
      <div class="areoi-card-body areoi-card-body-white" style="width: 40%; height: 100%; min-height: 300px;">
         ...
         <p>
            <a href="https://www.pexels.com/@mikhail-nilov/collections/" target="_blank">Mikhail Nilov</a>
         </p>
      </div><!-- .areoi-card-body -->
   </div><!-- .areoi-card -->
