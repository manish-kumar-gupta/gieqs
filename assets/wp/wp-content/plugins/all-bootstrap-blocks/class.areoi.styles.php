...
class AREOI_Styles
{
	...
	{
		$xs = str_replace( 'px', '', get_option( 'areoi-layout-grid-grid-breakpoint-xs', 0 ) );
		$sm = str_replace( 'px', '', get_option( 'areoi-layout-grid-grid-breakpoint-sm', 576 ) );
		$md = str_replace( 'px', '', get_option( 'areoi-layout-grid-grid-breakpoint-md', 768 ) );
		$lg = str_replace( 'px', '', get_option( 'areoi-layout-grid-grid-breakpoint-lg', 992 ) );
		$xl = str_replace( 'px', '', get_option( 'areoi-layout-grid-grid-breakpoint-xl', 1200 ) );
		$xxl = str_replace( 'px', '', get_option( 'areoi-layout-grid-grid-breakpoint-xxl', 1400 ) );
		...
		$widget_block = get_option( 'widget_block', null );
