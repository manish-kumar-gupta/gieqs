...
<div class="content">
	...
	*/
	...
	$slideIntro->defineSlide('intro', NULL, NULL, 'imagingPreEMR/Slide01.jpg', NULL, NULL, NULL, NULL);
	$slideIntro->generateSlide();

	
	$slide1 = new Slide();
	$slide1->defineSlide('1', NULL, 'https://player.vimeo.com/video/259752965', NULL, NULL, NULL, NULL);
...
var menuHeight = $('#menu').height();
	...
	$('.navbar').html("<a>Imaging prior to Endoscopic Mucosal Resection</a><a href='index.php'>Exit</a>");
