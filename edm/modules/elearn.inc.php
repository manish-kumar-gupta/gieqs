...
<div class="content">
	...
	*/
	...
	$slideIntro->defineSlide('intro', NULL, NULL, 'Slide01.jpg', NULL, NULL, NULL, NULL);
	$slideIntro->generateSlide();

	
	$slide1 = new Slide();
	$slide1->defineSlide('1', NULL, 'https://player.vimeo.com/video/231129179', NULL, NULL, NULL, NULL);
...
var menuHeight = $('#menu').height();
	...
	$('.navbar').html("<a>Cold Snare Polypectomy Learning Tool</a><a href='index.php'>Exit</a>");
