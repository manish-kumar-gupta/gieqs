...
<div class="content">
	...
	*/
	...
	$slideIntro->defineSlide('intro', NULL, NULL, 'introduction/Slide01.jpg', NULL, NULL, NULL, NULL);
	$slideIntro->generateSlide();

	
	$slide1 = new Slide();
	$slide1->defineSlide('1', NULL, 'https://player.vimeo.com/video/259750377', NULL, NULL, NULL, NULL);
...
var menuHeight = $('#menu').height();
	...
	$('.navbar').html("<a>Introduction to Endoscopic Mucosal Resection</a><a href='index.php'>Exit</a>");
