...
_k_referrer: { required: true },   
Sex: { required: true },   
Age: { required: true },   
Institution: { required: true },   
ProspectiveEthics: { required: true },   
Family_Hx: { required: true },   
Number_affected_FH: { required: true },   
Relationship_1: { required: true },   
Age_1_FH: { required: true },   
Relationship_2: { required: true },   
Age_2_FH: { required: true },   
},messages: {
_k_patient: { required: 'message' },   
_k_referrer: { required: 'message' },   
Sex: { required: 'message' },   
Age: { required: 'message' },   
Institution: { required: 'message' },   
ProspectiveEthics: { required: 'message' },   
Family_Hx: { required: 'message' },   
Number_affected_FH: { required: 'message' },   
Relationship_1: { required: 'message' },   
Age_1_FH: { required: 'message' },   
Relationship_2: { required: 'message' },   
Age_2_FH: { required: 'message' },   
},
