    ...
    <strong>Success!</strong> <span id="success"></span><button type="button" class="close" data-hide="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
              ...
              <ul class="section-nav">
				...
				<button class="btn btn-sm py-2 px-3 bg-dark-light mt-3 mb-3 mr-3" data-toggle="modal" data-target="#modal-POEM-ENG" id="showPOEMReport">Show Report</button>
				<button class="btn btn-sm py-2 px-3 bg-dark-light mt-3 mb-3 mr-3" data-toggle="modal" data-target="#modal-POEM-DUTCH" id="showPOEMReportDutch">Show Report (NED)</button>
		...
		$(document).ready(function () {
				...
				rules: {
					...
					ComplicationDetails: {
						required: function (element) {
							...
							if (($("#POEM_complication").val() == "1") && (($("#IPSubcutEmphysema").prop("checked") == false) && ($("#tunnel_exit").prop("checked") == false) && ($("#ComplicationDetails").val() == ''))) {
								return true;
			...
			$('#content').on('click', '#post_symptoms', function () { //TODO GENERALISE THIS IS THE CODE FOR A PARENT SELECTOR
