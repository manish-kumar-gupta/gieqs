<?php 
		...
		/*if (mysqli_connect_errno()) {
            ...
            $sql = "SELECT Name, Type, textType, Value1, Value2, Text, Message_t FROM pagelayoutercppatient WHERE position=".$iterationForm." AND Type IS NOT NULL ORDER BY `Order` ASC";
