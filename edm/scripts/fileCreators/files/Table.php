		...
		<body>
		    ...
		    <div id='content' class='content'>
		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                <div class='col-9'>
		                    <h2 style="text-align:left;">List of </h2>
		                </div>
		
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
		                    <p><button id="new" onclick="window.location.href = '<?php echo $roothttp;?>/scripts/forms/Form.php';">New </button></p>
		                </div>
		            </div>
		...
		break;
			...
			$(document).ready(function() {
				...
				$(".content").on("click", ".datarow", function(){
					...
					window.location.href = siteRoot + 'scripts/forms/Form.php?id=' + id;
