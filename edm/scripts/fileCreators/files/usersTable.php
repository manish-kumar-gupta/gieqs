		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
		                    <p><button id="newusers" onclick="window.location.href = '<?php echo $roothttp;?>/scripts/forms/usersForm.php';">New users</button></p>
		                </div>
		            </div>
			        ...
			        <div class='row'>
		                ...
		                <div class='col-10 narrow' style='overflow-x: scroll;'>
		                    <p><?php $general->makeTable("SELECT user_id from users"); ?></p>
		                </div>
		...
		break;
			...
			$(document).ready(function() {
				...
				$(".content").on("click", ".datarow", function(){
					...
					window.location.href = siteRoot + 'scripts/forms/usersForm.php?id=' + id;
