<?php 
           ...
           $row = $general->formIterator($iterationForm, $tableNameSheet);
           ...
           //print_r($row);
            ...
            foreach($row as $key=>$value) {
                ...
                if (($value["Type"])==1){
                    generateSelect (($value["Text"]), ($value["Name"]) , ($value["Value1"]), ($value2), $_POST[($value["Name"])], ($value["Message_t"]), $general, $tableNameValues); 
                ...
                elseif (($value["Type"])==3){
                    generateChecked(($value["Text"]), ($value["Name"]), ($value["Message_t"])); 
