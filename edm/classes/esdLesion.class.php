...
Class esdLesion {
	...
	public function matchRecord($key_row){
		//does the passed key exist in the database?
		$result = $this->connection->RunQuery("Select * from esdLesion where _k_lesion = \"$key_row\" ");
	...
	public function Delete_row_from_key($key_row){
		$result = $this->connection->RunQuery("DELETE FROM esdLesion WHERE _k_lesion = $key_row");
	...
	public function prepareStatementPDO (){ //inserts new object to the database based on current data
	...
	public function prepareStatementPDOUpdate (){ //updates given row to the database based on current object data
